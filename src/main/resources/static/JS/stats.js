...
var Stats=function(){
    ...
    d.style.color="rgb("+b.fps.fg.r+","+b.fps.fg.g+","+b.fps.fg.b+")";d.style.margin="0px 0px 1px 3px";
    ...
    return{
         ...
         domElement:g,update:function(){
            ...
            c.innerHTML='<span style="font-weight:bold">'+n+" MS</span> ("+z+"-"+A+")";o.putImageData(B,0,0);
            F=j;
            if(j>v+1E3){
